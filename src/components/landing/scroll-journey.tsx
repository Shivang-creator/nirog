...
const SCENES: Scene[] = [
  ...
  },
  {
    ...
    body: "Notes, prescription and follow-up are filed under the doctor's registration and returned to the patient's case file — quoted in their own words, with what was not established written down beside what was.",
    tags: ["Signed prescriptions", "SBAR handover", "Verbatim record"],
    accent: "var(--amber)",
